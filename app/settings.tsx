...
export default function SettingsScreen() {
  ...
  const { operatingState, setOperatingState } = useApp();
  ...
  const [monthlyIncome, setMonthlyIncome] = useState('18,500');
  const [age, setAge] = useState('28');
  const [shgActive, setShgActive] = useState(true);
      ...
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View className="bg-surface-container-low rounded-xl p-4 shadow-sm mb-4 gap-3">
          <View className="flex-row items-center gap-1.5 mb-1">
            ...
            <Text className="font-headline-sm text-[18px] font-bold text-on-surface">Assistance & Guides</Text>
          </View>
          ...
          >
            <View className="flex-row items-center gap-3">
              ...
              <View className="flex-col">
                <Text className="font-headline-sm text-[15px] font-bold text-on-surface">Replay Interactive Tour</Text>
                <Text className="font-body-sm text-[12px] text-on-surface-variant">Step-by-step audio walkthrough</Text>
              </View>
            </View>
