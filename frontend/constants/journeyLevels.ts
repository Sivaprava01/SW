/**
 * 15-Level Curated Financial Education Journey Catalog for Sakhi.
 * Structured across 5 progressive tiers from basic money awareness to financial future planning.
 * Deterministic, curated, locally available single-paragraph practical lessons + Indic voice narration (Telugu, Hindi, English).
 */
...
export const JOURNEY_LEVELS: JourneyLevelData[] = [
  ...
  // ==========================================
  {
    ...
    title: {
      en: 'Bank Accounts & Digital Payments',
...
/* ========================================================================= */
/* ARCHIVED: 50-LEVEL EXPANDED CATALOG (PRESERVED FOR FUTURE AI ROADMAP)    */
/* The definitions below preserve the complete 50-level curriculum for future*/
/* dynamic expansion and AI-assisted updates.                               */
/* ========================================================================= */
/*
export const ARCHIVED_50_LEVEL_CATALOG: JourneyLevelData[] = [
  // Levels 16 to 50 are preserved in source repository documentation:
  // - Level 16: Sukanya Samriddhi Yojana (SSY) for Daughters
  // - Level 17: Post Office Monthly Income Scheme (POMIS)
  // - Level 18: Gold Monetization & Sovereign Gold Bonds (SGB)
  // - Level 19: Mutual Fund SIP Basics (Systematic Investment Plan)
  // - Level 20: Avoiding Chit Fund Frauds & Ponzi Schemes
  // - Level 21: Pradhan Mantri Suraksha Bima Yojana (PMSBY)
  // - Level 22: Pradhan Mantri Jeevan Jyoti Bima Yojana (PMJJBY)
  // - Level 23: Ayushman Bharat PM-JAY Health Protection
  // - Level 24: Crop & Livestock Insurance (PMFBY & Cattle Cover)
  // - Level 25: Nominations & Wills: Securing Property Rights
  // - Level 26: Forming & Managing an SHG (Self Help Group)
  // - Level 27: SHG Internal Lending vs Bank Linkage
  // - Level 28: Pradhan Mantri Mudra Yojana (Shishu, Kishore, Tarun)
  // - Level 29: Stand-Up India & PM-SVANidhi for Street Vendors
  // - Level 30: Pricing, Profit Margins & Working Capital for Women
  // - Level 31: Mahila Samman Savings Certificate (MSSC)
  // - Level 32: Atal Pension Yojana (APY) for Retirement
  // - Level 33: Free Legal Aid & Women's Financial Rights
  // - Level 34: Digital Literacy & Preventing Cyber Financial Frauds
  // - Level 35: Lakhpati Didi Scheme & Sustainable Village Wealth
  // - Level 36: Understanding Credit Scores (CIBIL) & Building Good Credit
  // - Level 37: Cooperative Banks vs Commercial Banks
  // - Level 38: Kisan Credit Card (KCC) for Agriculture & Animal Husbandry
  // - Level 39: Warehouse Receipts & Avoiding Distress Harvest Sales
  // - Level 40: Solar Pump & Agri-Infrastructure Subsidies
  // - Level 41: Skill India & Vocational Training Grants for Rural Women
  // - Level 42: Food Processing Enterprise Subsidies (PMFME Scheme)
  // - Level 43: Handloom & Handicraft Artisan Schemes (PM Vishwakarma)
  // - Level 44: Direct Benefit Transfer (DBT) & Aadhaar-Enabled Payments
  // - Level 45: Ration Card Portability & One Nation One Ration Card
  // - Level 46: Jal Jeevan Mission & Reducing Household Health Expenses
  // - Level 47: PM Ujjwala Yojana & Clean Energy Savings
  // - Level 48: Housing Subsidies (Pradhan Mantri Awas Yojana - Gramin)
  // - Level 49: Financial Estate Planning: Successions and Land Titles
  // - Level 50: Grand Milestone: Sakhi Certified Financial Leader
];
*/
