        ...
        <ScrollView className="flex-1 px-4 py-3" contentContainerStyle={{ paddingBottom: 30 }}>
          ...
          <View className="items-center py-2 mb-3">
            <View className="relative mb-2">
              <View className="w-20 h-20 rounded-full bg-primary items-center justify-center shadow-md">
                <Text className="text-3xl font-bold text-on-primary">L</Text>
              </View>
            ...
            <Text className="text-xl font-bold text-on-surface">Lakshmi Devi</Text>
            <Text className="text-xs text-on-surface-variant text-center mt-0.5">
              Tailoring & Micro-Retail • Rural Village, Khammam, {operatingState}
            </Text>
            ...
            <View className="mt-2 flex-row items-center bg-surface-container-low px-3 py-1.5 rounded-full border border-surface-container-highest/60">
              ...
              <Text className="text-xs font-bold text-primary ml-1.5">
                Active SHG Member (SERP ID: TG-48209)
              </Text>
            </View>
          </View>
          ...
          <View className="w-full bg-surface-container-low rounded-xl p-3.5 mb-2.5 shadow-sm border border-surface-container-highest/60">
            ...
            <View className="flex-row items-baseline justify-between mt-1">
              <Text className="text-2xl font-bold text-primary">₹18,500</Text>
              <View className="bg-surface-container px-2.5 py-1 rounded">
                <Text className="text-xs font-semibold text-on-surface">Tailoring & Shop Sales</Text>
              </View>
            </View>
          </View>
          ...
          <TouchableOpacity
            onPress={handleOpenSettings}
            className="w-full min-h-[50px] bg-primary-container rounded-xl flex-row items-center justify-center active:scale-[0.99] shadow-md">
